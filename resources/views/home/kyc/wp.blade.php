<div class="basicBlock__content">
    ...
    <div class="btnConainer text-center"><a class="btn btn--whitePaper btn--small" href="{{ asset('wp/Mitoshi_Whitepaper_2018.pdf') }}" target="_blank">{!! trans('home/kyc.whitePaper_btn') !!}</a></div>
