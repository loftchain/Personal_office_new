    ...
    <div class="login modalFrame">
        ...
        <form class="loginForm icoForm" action="{{ route('login') }}" method="POST">
            ...
            <div class="formControl">
                ...
                <input class="icoForm__input" type="email" name="email" required placeholder="user@demo.io">
            </div>
            ...
            <div class="formControl">
                ...
                <input class="icoForm__input" type="password" name="password" required placeholder="Password123!">
