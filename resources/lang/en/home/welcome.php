...
return [
  ...
  'welcome_second' => '<span class="welcome__demo-start">To</span> enter as a user, press login: <span class="welcome__demo-underlined">user@demo.io</span>, password:Password123! (all the data is already kindly inserted in text inputs)',
